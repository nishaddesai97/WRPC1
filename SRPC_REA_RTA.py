...
def fetch_pdf_urls(month, year, doc_type):
  if month.lower() in ['january', 'february']:
    ...
    base_year = year
  base_url = f"https://www.srpc.kar.nic.in/website/{base_year}/commercial/"
...
def fetch_data(year, month):
      doc_type = "REA"
      search_terms = ["SPRNG,NPKUNTA", "Fortum Solar,PAVAGADA","SPRNG,PUGULUR", "Sprng Solar India Pvt.Ltd,PAVAGADA"]  # entity names,Sprng Solar India Pvt.Ltd,PAVAGADA 
